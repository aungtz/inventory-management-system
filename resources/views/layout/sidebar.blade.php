...
<aside class="sidebar fixed lg:relative top-0 left-0 z-40 bg-gradient-to-b from-slate-900 via-slate-900 to-slate-800 backdrop-blur border-r border-slate-700/80 shadow-xl lg:shadow-none">
  ...
  <div class="p-4 space-y-2">
    ...
    <a href="/items" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-slate-700/50 transition-colors text-slate-300 hover:text-white">
      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
     ...
     <a href="/items/create" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-slate-700/50 transition-colors text-slate-300 hover:text-white">
